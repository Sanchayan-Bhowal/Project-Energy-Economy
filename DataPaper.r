...
ggplot(data = data, aes(ln_price_1)) +
  geom_histogram(aes(y = ..count../sum(..count..)), binwidth = 0.18, col = border, fill = fill) +
  ylab("Fraction") +
...
ggplot(data = data, aes(perc_change_p2_to_p1)) +
  geom_histogram(aes(y = ..count../sum(..count..)), binwidth = 0.3, col = border, fill = fill) +
  ylab("Fraction") +
...
ggplot(data = data, aes(days_between_sale)) +
  geom_histogram(aes(y = ..count../sum(..count..)), bins = 35, col = border, fill = fill) +
  ylab("Fraction") +
...
ggplot(data = data, aes(epc_100)) +
  geom_histogram(aes(y = ..count../sum(..count..)), bins = 36, col = border, fill = fill) +
  ylab("Fraction") +
...
ggplot(data = data, aes(imd_score)) +
  geom_histogram(aes(y = ..count.. / sum(..count..)), bins = 30, col = border, fill = fill) +
  ylab("Fraction") +
